...
@property (weak, nonatomic) IBOutlet UIView *creatView;//背景
@property (weak, nonatomic) IBOutlet UIImageView *background;//背景图
...
@property (weak, nonatomic) IBOutlet UIButton *getUpBtn;//起身
